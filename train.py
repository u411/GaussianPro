...
if __name__ == "__main__":
    ...
    parser.add_argument("--test_iterations", nargs="+", type=int, default=[1, 2000, 7000, 10000, 50000])
    parser.add_argument("--save_iterations", nargs="+", type=int, default=[1, 7000, 10000, 50000])
